...
public class LibraryManagementTest {
	...
	public void testBookId() {
		...
		try { Book book1 = new Book(100, "book 1"); assertTrue(book1.isValidId(book1.getId())); }
		catch (Exception e) { System.out.println("Invalid ID"); }
		
		try { Book book2 = new Book(999, "book 2"); assertTrue(book2.isValidId(book2.getId()));}
		catch (Exception e) { System.out.println("Invalid ID"); }
		
		try { Book book3 = new Book(1000, "book 3"); assertTrue("Invalid ID", book3.isValidId(book3.getId()));}
		catch (Exception e) { System.out.println("Invalid ID"); }
		
		try { Book book4 = new Book(10, "book 4"); assertTrue("Invalid ID", book4.isValidId(book4.getId()));}
		catch (Exception e) { System.out.println("Invalid ID"); }
		
		try { Book book5 = new Book(1997812, "book 5"); assertTrue("Invalid ID", book5.isValidId(book5.getId()));}
		catch (Exception e) { System.out.println("Invalid ID"); }
	}
